...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (pyvenv pyenv-mode-auto ac-octave realgud cython-mode elpy pipenv yaml-mode slime rainbow-delimiters neotree markdown-mode magit jedi flycheck company-anaconda color-theme-modern ace-window ace-jump-mode)))
