...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (ac-octave realgud cython-mode elpy pipenv yaml-mode slime rainbow-delimiters neotree markdown-mode magit jedi flycheck ein company-anaconda color-theme-modern ace-window ace-jump-mode)))
